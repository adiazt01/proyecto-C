...
void crearExpediente(struct Expediente *expediente) {
    ...
    printf("Expediente creado exitosamente.\n");
}
...
void generarPago(struct Cuenta *cuenta) {
    ...
    printf("2. Pago móvil\n");
      ...
      printf("3. Pago en efectivo en bolívares\n");
    printf("4. Pago en efectivo en dólares\n");
    ...
    switch (opcion) {
        ...
        case 2:
            ...
            break;
        case 3:
            printf("Ingrese el monto en efectivo en bolívares: ");
            scanf("%f", &monto);
            cuenta->saldo -= monto;
            printf("Pago en efectivo en bolívares realizado correctamente.\n");
            break;
        case 4:
            printf("Ingrese el monto en efectivo en dólares: ");
            scanf("%f", &monto);
            cuenta->saldo -= monto;
...
// Función para generar un resumen de actividad semanal y mensual realizada en el banco
...
// Función para consultar e imprimir movimientos diarios, semanales y mensuales en el banco
...
// Función para crear, consultar e imprimir retiros diarios, semanales y mensuales en el banco
void crearRetiros() {
    printf("\nCREAR RETIROS\n");
...
int main() {
    ...
    do {
        ...
        printf("5. Mostrar productos y requisitos del banco\n");
        printf("6. Generar cobro por servicio de la cuenta\n");
        printf("7. Generar pago en la cuenta\n");
        printf("8. Generar resumen de actividad semanal y mensual\n");
        printf("9. Consultar e imprimir movimientos diarios, semanales y mensuales en el banco\n");
        printf("10. Crear, consultar e imprimir retiros diarios, semanales y mensuales en el banco\n");
