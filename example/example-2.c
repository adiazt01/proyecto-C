...
int main() {
    ...
    do {
        ...
        printf("9. Consultar e imprimir movimientos diarios, semanales y mensuales del banco\n");
        printf("10. Crear, consultar e imprimir retiros diarios, semanales y mensuales del banco\n");
